...
public final class Autos {
    ...
    public static Command autoOptimize(Drivebase drivebase, RotateShooterSubsystem rotateShooterSubsystem,
        ...
        Command runAutoCommand = Commands.deadline(
                ...
                shooterSubsystem.shootRateControlCmd());
        char pre = '0';
        ...
        for (int i = 0; i < length; i++) {
            ...
            switch (cur) {
                case '1':
                    runAutoCommand
                            .andThen(Commands.deadline(new TransportToShootCmd(transportSubsystem, shooterSubsystem),
                                    shooterSubsystem.shootRateControlCmd()));
                    break;
                case '2':
                    runAutoCommand
    ...
    public static Command autoWithOnlyPose(Drivebase drivebase, RotateShooterSubsystem rotateShooterSubsystem,
        ...
        for (int i = 0; i < length; i++) {
            ...
            switch (cur) {
                case '1':
                    runAutoCommand
                            .andThen(new TransportToShootCmd(transportSubsystem, shooterSubsystem));
                    break;
                case '2':
                    runAutoCommand
                            .andThen(new TransportToShootCmd(transportSubsystem, shooterSubsystem));
