...
public final class Autos {
    ...
    public static Command blueAmp(Drivebase drivebase, IntakeSubsystem intakeSubsystem,
        ...
        cmd.andThen(new ParallelDeadlineGroup(new WaitCommand(0.3).andThen(AutoTransport), AutoAimControl, AutoTag));
        cmd.andThen(drivebase.followPathCommand(AutoConstants.Amp3), AutoNote);

        cmd.andThen(
                new ParallelDeadlineGroup(drivebase.followPathCommand(AutoConstants.Amp4), AutoIntakeWithTransport));
        cmd.andThen(drivebase.followPathCommand(AutoConstants.Amp5));
        cmd.andThen(new ParallelDeadlineGroup(new WaitCommand(0.3).andThen(AutoTransport), AutoAimControl, AutoTag));

        cmd.andThen(drivebase.followPathCommand(AutoConstants.Amp6));
        cmd.andThen(
                new ParallelDeadlineGroup(drivebase.followPathCommand(AutoConstants.Amp7), AutoIntakeWithTransport));
    ...
    public static Command blueMiddle(Drivebase drivebase, IntakeSubsystem intakeSubsystem,
        ...
        cmd.andThen(
                new ParallelDeadlineGroup(drivebase.followPathCommand(AutoConstants.Middle2), AutoIntakeWithTransport));
        cmd.andThen(new ParallelDeadlineGroup(new WaitCommand(0.3).andThen(AutoTransport), AutoAimControl, AutoTag));
        cmd.andThen(drivebase.followPathCommand(AutoConstants.Middle3), AutoNote);

        cmd.andThen(
                new ParallelDeadlineGroup(drivebase.followPathCommand(AutoConstants.Middle4), AutoIntakeWithTransport));
        ...
        cmd.andThen(
                new ParallelDeadlineGroup(drivebase.followPathCommand(AutoConstants.Middle7), AutoIntakeWithTransport));
