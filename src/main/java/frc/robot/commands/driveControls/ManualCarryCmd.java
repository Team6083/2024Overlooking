...
public class ManualCarryCmd extends Command {
  ...
  public ManualCarryCmd(ShooterSubsystem shooterSubsystem, CommandXboxController main) {
    ...
    addRequirements(this.shooterSubsysteme);
  }

  // Called every time the scheduler runs while the command is scheduled.
  @Override
  public void execute() {
    magnification = shooterSubsystem.getMagnification();
